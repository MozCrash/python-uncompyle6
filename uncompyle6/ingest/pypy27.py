...
"""
Python PyPy 2.7 bytecode ingestion
...
import uncompyle6.ingest.scanner27 as ingest
...
class ScannerPyPy27(ingest.Scanner27):
    def __init__(self, show_asm):
        # There are no differences in initialization between
        # pypy 2.7 and 2.7
        ingest.Scanner27.__init__(self, show_asm, is_pypy=True)
        self.version = 2.7
        return

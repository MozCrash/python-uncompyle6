...
"""
Python PyPy 3.2 bytecode ingestion
...
import uncompyle6.ingest.scanner32 as ingest
...
class ScannerPyPy32(ingest.Scanner32):
    def __init__(self, show_asm):
        # There are no differences in initialization between
        # pypy 3.2 and 3.2
        ingest.Scanner32.__init__(self, show_asm, is_pypy=True)
        self.version = 3.2
        return
